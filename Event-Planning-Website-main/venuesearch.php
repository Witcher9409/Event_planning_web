...
<body>
    ...
    <ul>
        ...
        <li style="float:right"><a class="active" href="venue.php">Back</a></li>
    </ul>
    <style>
        ul {
    ...
    <div class="container">
        <div class="products">
            ...
            <div class="box-container">
                ...
                $res1=showsearch($Search);

                while ($fetch_product = mysqli_fetch_assoc($res1)) {
                    ?>
                    <form method="post" class="box" action="../Controllers/venuesearchCheckController.php">
