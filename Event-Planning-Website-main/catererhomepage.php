...
<body style="background-color:	lavender;text-align:center">
   ...
   <body>
      ...
      <form method="post">
         <ul>
            <li><a href="catererhomepage.php">Home</a></li>
            <li><a href="catererprofile.php">My Profile</a></li>
            <li><a href="catererproducts.php">My Products</a></li>
            <li><a href="catererorders.php">My Orders</a></li>
         ...
         <div>
            ...
            <section class="category-profile">
               ...
               <div class="box-container">
                  ...
                  <a href="catererprofile.php?category=userprofile" class="box">
                     <img src="user.png" alt="">
                     <h3>My Profile</h3>
                  </a>

                  <a href="catererproducts.php?category=wallet" class="box">
                     <img src="product.png" alt="">
                     <h3>My Products</h3>
                  </a>

                  <a href="catererorders.php?category=wishlist" class="box">
