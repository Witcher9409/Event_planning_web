...
require_once('../Models/photographydb.php');
...
<body>
    ...
    <ul>
        ...
        <li style="float:right"><a class="active" href="photography.php">Back</a></li>
    </ul>
    ...
    <div class="container">
        <div class="products">
            ...
            <div class="box-container">
                ...
                $res=showsearch($Search);


                while ($fetch_product = mysqli_fetch_assoc($res)) {
                    ?>
                    <form method="post" class="box" action="../Controllers/photographysearchCheckController.php">
