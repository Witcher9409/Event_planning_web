...
<body>
    <ul>
        ...
        <li><a href="../Views/usercart.php">My Cart</a></li>
        ...
        <div class="products">
            ...
            <div class="box-container">
                ...
                while ($fetch_product = mysqli_fetch_assoc($res)) {
                    ?>
                    <form method="post" class="box" action="../Controllers/userwishCheckController.php">
                        ...
                        <input type="submit" value="remove from wishlist" name="remove_from_wishlist" class="btn">
