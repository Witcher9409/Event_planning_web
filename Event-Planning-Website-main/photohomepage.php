...
<body style="background-color:	lavender;text-align:center">
   ...
   <body>
      <form method="post">
         <ul>
            <li><a href="photohomepage.php">Home</a></li>
            <li><a href="photoprofile.php">My Profile</a></li>
            <li><a href="photographerproducts.php">My Products</a></li>
            <li><a href="photoorders.php">My Orders</a></li>
         ...
         <div>
            ...
            <section class="category-profile">
               ...
               <div class="box-container">
                  ...
                  <a href="photoprofile.php?category=userprofile" class="box">
                     <img src="user.png" alt="">
                     <h3>My Profile</h3>
                  </a>

                  <a href="photographerproducts.php?category=product" class="box">
                     <img src="product.png" alt="">
                     <h3>My Products</h3>
                  </a>

                  <a href="photoorders.php?category=order" class="box">
